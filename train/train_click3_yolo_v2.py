"""
v2 YOLO 训练 — yolov8s + 200 epoch + 强 augmentation。

相对 train_click3_yolo.py 的关键改动:
  - model: yolov8s.pt (11M, 3x of yolov8n)
  - imgsz: 640 (vs 416)
  - epochs: 200 (vs 100)
  - patience: 50 (vs 30)
  - mosaic=1.0, copy_paste=0.3, erasing=0.0
  - lr0=0.005, warmup=5
  - 输出: runs/click3/pair_yolov8s_v2/
  - 测试集自动跑 mAP

用法:
  python train_click3_yolo_v2.py
  python train_click3_yolo_v2.py --epochs 200 --imgsz 640 --batch 8
"""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--data", type=Path, default=Path("dataset/click3_yolo_pair/data.yaml"))
    ...
    parser.add_argument("--project", type=Path, default=Path("runs/click3"))
    parser.add_argument("--name", default="pair_yolov8s_v2")
